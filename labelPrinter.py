...
def print_user(user):
    ...
    font_gap = { "height": 6, "weight": 400, "charSet": FONT_CHAR_SET, "faceName": FONT_FACE_NAME }
    font_header = { "height": 12, "weight": 400, "charSet": FONT_CHAR_SET, "faceName": FONT_FACE_NAME }
    font_name = { "height": 24, "weight": 600, "charSet": FONT_CHAR_SET, "faceName": FONT_FACE_NAME }
    font_company = { "height": 16, "weight": 600, "charSet": FONT_CHAR_SET, "faceName": FONT_FACE_NAME }
    font_title = { "height": 14, "weight": 400, "italic": True, "charSet": FONT_CHAR_SET, "faceName": FONT_FACE_NAME }
